...
Module['FS_createPath']("/", "shaders", true, true);
    ...
    loadPackage({"files": [{"filename": "/shaders/grain.fs", "start": 0, "end": 1182}], "remote_package_size": 1182});

  })();

// end include: /tmp/tmpb3jm8s9h.js
// include: /tmp/tmpvdgrekql.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpvdgrekql.js
// include: /tmp/tmp6odte727.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmp6odte727.js
...
var ASM_CONSTS = {
 ...
 139669: ($0) => { window.miniaudio.untrack_device_by_index($0); },  
 139719: ($0) => { var device = window.miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = window.miniaudio.device_state.started; },  
 139858: ($0) => { var device = window.miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = window.miniaudio.device_state.stopped; },  
 139998: () => { if (document.fullscreenElement) return 1; },  
 140044: () => { return Module.canvas.width; },  
 140076: () => { return parseInt(Module.canvas.style.width); },  
 140124: () => { document.exitFullscreen(); },  
 140151: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 140224: () => { if (document.fullscreenElement) return 1; },  
 140270: () => { return Module.canvas.width; },  
 140302: () => { return screen.width; },  
 140327: () => { document.exitFullscreen(); },  
 140354: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 140487: () => { return window.innerWidth; },  
 140513: () => { return window.innerHeight; },  
 140540: () => { if (document.fullscreenElement) return 1; },  
 140586: () => { return Module.canvas.width; },  
 140618: () => { return parseInt(Module.canvas.style.width); },  
 140666: () => { if (document.fullscreenElement) return 1; },  
 140712: () => { return Module.canvas.width; },  
 140744: () => { return screen.width; },  
 140769: () => { return window.innerWidth; },  
 140795: () => { return window.innerHeight; },  
 140822: () => { if (document.fullscreenElement) return 1; },  
 140868: () => { return Module.canvas.width; },  
 140900: () => { return screen.width; },  
 140925: () => { document.exitFullscreen(); },  
 140952: () => { if (document.fullscreenElement) return 1; },  
 140998: () => { return Module.canvas.width; },  
 141030: () => { return parseInt(Module.canvas.style.width); },  
 141078: () => { document.exitFullscreen(); },  
 141105: ($0) => { Module.canvas.style.opacity = $0; },  
 141143: () => { return screen.width; },  
 141168: () => { return screen.height; },  
 141194: () => { return window.screenX; },  
 141221: () => { return window.screenY; },  
 141248: () => { return window.devicePixelRatio; },  
 141284: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 141337: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 141388: () => { Module.canvas.style.cursor = 'none'; },  
 141425: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 141681: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 141732: () => { if (document.pointerLockElement) return 1; },  
 141779: () => { if (document.fullscreenElement) return 1; },  

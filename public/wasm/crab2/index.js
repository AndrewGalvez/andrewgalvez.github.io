...
var ASM_CONSTS = {
 ...
 160260: ($0) => { return window.miniaudio.get_device_by_index($0).webaudio.sampleRate; },  
 160333: ($0) => { var device = window.miniaudio.get_device_by_index($0); if (device.scriptNode !== undefined) { device.scriptNode.onaudioprocess = function(e) {}; device.scriptNode.disconnect(); device.scriptNode = undefined; } if (device.streamNode !== undefined) { device.streamNode.disconnect(); device.streamNode = undefined; } device.webaudio.close(); device.webaudio = undefined; device.pDevice = undefined; },  
 160733: ($0) => { window.miniaudio.untrack_device_by_index($0); },  
 160783: ($0) => { var device = window.miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = window.miniaudio.device_state.started; },  
 160922: ($0) => { var device = window.miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = window.miniaudio.device_state.stopped; },  
 161062: () => { if (document.fullscreenElement) return 1; },  
 161108: () => { return Module.canvas.width; },  
 161140: () => { return parseInt(Module.canvas.style.width); },  
 161188: () => { document.exitFullscreen(); },  
 161215: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 161288: () => { if (document.fullscreenElement) return 1; },  
 161334: () => { return Module.canvas.width; },  
 161366: () => { return screen.width; },  
 161391: () => { document.exitFullscreen(); },  
 161418: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 161551: () => { return window.innerWidth; },  
 161577: () => { return window.innerHeight; },  
 161604: () => { if (document.fullscreenElement) return 1; },  
 161650: () => { return Module.canvas.width; },  
 161682: () => { return parseInt(Module.canvas.style.width); },  
 161730: () => { if (document.fullscreenElement) return 1; },  
 161776: () => { return Module.canvas.width; },  
 161808: () => { return screen.width; },  
 161833: () => { return window.innerWidth; },  
 161859: () => { return window.innerHeight; },  
 161886: () => { if (document.fullscreenElement) return 1; },  
 161932: () => { return Module.canvas.width; },  
 161964: () => { return screen.width; },  
 161989: () => { document.exitFullscreen(); },  
 162016: () => { if (document.fullscreenElement) return 1; },  
 162062: () => { return Module.canvas.width; },  
 162094: () => { return parseInt(Module.canvas.style.width); },  
 162142: () => { document.exitFullscreen(); },  
 162169: ($0) => { Module.canvas.style.opacity = $0; },  
 162207: () => { return screen.width; },  
 162232: () => { return screen.height; },  
 162258: () => { return window.screenX; },  
 162285: () => { return window.screenY; },  
 162312: () => { return window.devicePixelRatio; },  
 162348: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 162401: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 162452: () => { Module.canvas.style.cursor = 'none'; },  
 162489: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 162745: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 162796: () => { if (document.pointerLockElement) return 1; },  
 162843: () => { if (document.fullscreenElement) return 1; },  
 162889: () => { return window.innerWidth; },  
 162915: () => { return window.innerHeight; }
};
